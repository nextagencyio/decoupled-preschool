...
function PageNotFound({ path }: { path: string }) {
  return (
    <div className="text-center py-16">
      <div className="bg-white rounded-3xl shadow-lg shadow-primary-100/30 p-12 border-2 border-primary-100">
        <h1 className="text-2xl font-bold font-display text-primary-800 mb-4">Page Not Found</h1>
    ...
    return (
      <div className="min-h-screen bg-amber-50">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <ErrorBoundary>
            <article className="bg-white rounded-3xl shadow-lg shadow-primary-100/30 overflow-hidden border-2 border-primary-100">
              {image && (
                <ResponsiveImage
                  image={image}
                  alt={image.alt || title}
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-display text-primary-800 mb-4 md:mb-6">{title}</h1>
